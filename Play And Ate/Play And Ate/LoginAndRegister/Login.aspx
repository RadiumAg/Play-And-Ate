                ...
                <div class="user-lr-box-left f_l">
                    <div style="margin: 10px;">
                        ...
                        <div class="field email">
                            ...
                            <input type="text" value="" class="f-input ipttxt" id="login-email-address" name="email" required="required" size="30" tabindex="1">
                        </div>
                        <div class="field password">
                            <label for="login-password">密码</label>
                            <input type="password" value="" class="f-input ipttxt" id="login-password" required="required" name="user_pwd" size="30" tabindex="2">
                        ...
                        <div class="field autologin">
                            <div class="input" style="width: 500px;">
                                ...
                                <input type="button" value="换一换" class="c" style="text-align: center; height: 30px; vertical-align: middle;" onclick="createCode()">
                            </div>
                        </div>
                    </div>
                    <div class="field autologin">
