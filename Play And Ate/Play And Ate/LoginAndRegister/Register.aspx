		...
		<div class="inc_main pd10 clearfix">
	        ...
	        <div class=" p20 f14">
	            <form action="http://sh.01nz.com.cn/user-doregister" method="post" id="signup-user-form">
								...
								<div class="field username" id="reg_mobile">
									...
									<div style="float:left; margin-left: 15em;  margin-top:-37px;"><input id="get-code" type="button" style="height:30px;" value="获取验证码"></div>
								</div>
								<div class="blank"></div>
								<div class="act">
       	...
       	<!--注册 end-->
				...
				<div class="user-lr-box-right f_r" style=" margin-top:-50px">
					<div style=" width:227px;"><a href="http://sh.01nz.com.cn/user-login"><img src="./第一农庄网_会员注册_files/denglu.png" alt="登陆" width="227" height="30"></a></div>
					<div class="app_login_box">
					<div class="blank10"></div>
					<h3>合作网站账号登录</h3><div class="blank10"></div><div class="blank10"></div><span id="api_Sina_1"><a href="https://api.weibo.com/oauth2/authorize?client_id=1124953983&amp;redirect_uri=http%3A%2F%2Fsh.01nz.com.cn%2Fapi_callback.php%3Fc%3DSina&amp;response_type=code" title="用微博登陆"><img src="./第一农庄网_会员注册_files/52a1881254edd.png" alt="用微博登陆"></a>&nbsp;</span><div class="blank10"></div><span id="api_Qqv2_1"><a href="http://www.01nz.com.cn/system/api_login/qqv2/qq_login.php" title="用QQ账号登陆"><img src="./第一农庄网_会员注册_files/52d0f08581839.png" alt="用QQ账号登陆"></a>&nbsp;</span><div class="blank10"></div><span id="api_Wechat_0"><a title="用微信登陆" href="https://open.weixin.qq.com/connect/qrconnect?appid=wx6431ca26112607a7&amp;redirect_uri=http%3A%2F%2F01nz.com.cn%2Fuser-welogin%2F&amp;response_type=code&amp;scope=snsapi_login&amp;state=STATE#wechat_redirect"><img alt="用微信登陆" src="./第一农庄网_会员注册_files/wechat.png"></a>&nbsp;</span>					</div>
					<div style=" width:270px;"><adv adv_id="微信展示"></adv></div>
				</div>
			</div>		
...
<asp:Content ID="Content3" ContentPlaceHolderID="Footer" runat="server">
	...
	<!-- 热门城市 -->
		...
		<div align="center"><img src="./第一农庄网_会员注册_files/xian.jpg" alt="灰线"></div>
		<div align="center">
			<img src="./第一农庄网_会员注册_files/jubao.gif" alt="举报中心" class="img">
			<img src="./第一农庄网_会员注册_files/end_2.gif" alt="官方认证" class="img">
			<a href="https://www.sgs.gov.cn/lz/licenseLink.do?method=licenceView&amp;entyId=dov73ne2cve0r70m02lemast61960airrs" target="_blank"><img src="./第一农庄网_会员注册_files/icon.gif" border="0"></a>
		    <img src="./第一农庄网_会员注册_files/end_3.gif" alt="网络110" class="img">
			<img border="0" src="./第一农庄网_会员注册_files/image_err.gif">
			<a href="http://shwg.dianping.com/index.html?tp=1.1.20.0.27.LKAvY0C-00-8v9E9&amp;ti=AY74lO" target="_blank"><img border="0" src="./第一农庄网_会员注册_files/wg.png"></a>
		</div>
			<div class="blank"></div>
			<div class="blank"></div>
			<div class="blank"></div>
...
<!--})();-->
<!--</script>-->
<script src="./第一农庄网_会员注册_files/z_stat.php" language="JavaScript"></script><script src="./第一农庄网_会员注册_files/core.php" charset="utf-8" type="text/javascript"></script><a href="https://www.cnzz.com/stat/website.php?web_id=1254939469" target="_blank" title="站长统计">站长统计</a>

<script src="./第一农庄网_会员注册_files/c.js.下载" language="JavaScript"></script><script src="./第一农庄网_会员注册_files/tongji_360.php" language="JavaScript" charset="gb2312"></script><script src="./第一农庄网_会员注册_files/core(1).php" charset="utf-8" type="text/javascript"></script><a href="https://quanjing.cnzz.com/" target="_blank" title="全景统计"><img border="0" hspace="0" vspace="0" src="./第一农庄网_会员注册_files/2.gif"></a>
<!--<script type="text/javascript">-->
