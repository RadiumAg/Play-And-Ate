...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    ...
    <div class="warps">
            ...
            <div class="tar_mr">
                <ul>
                    <li>
                        ...
                        <a href="http://www.01nz.com.cn/notice/273.html" target="_blank">
                            <div id="asdf" class="mt_gs_bb f-14 f_l  mt_gs_jsa">查看他的农家故事 &gt;</div>
                        </a>
                    </li>
                    <li>
                        ...
                        <div class="f-16 ">庆幸选择第一农庄网</div>
                        <a href="http://www.01nz.com.cn/notice/264.html" target="_blank">
                            <div id="asdf" class="mt_gs_bb f-14 f_l  mt_gs_jhh">查看他的农家故事 &gt;</div>
                        </a>
                    </li>
                    <li>
                        ...
                        <div class="f-16 ">庆幸选择第一农庄网</div>
                        <a href="http://www.01nz.com.cn/notice/258.html" target="_blank">
                            <div id="asdf" class="mt_gs_bb f-14 f_l  mt_gs_joo">查看他的农家故事 &gt;</div>
                        </a>
                    </li>
                    <li>
                        ...
                        <div class="f-16 ">庆幸选择第一农庄网</div>
                        <a href="http://www.01nz.com.cn/notice/255.html" target="_blank">
                            <div id="asdf" class="mt_gs_bb f-14 f_l  mt_gs_jsb">查看他的农家故事 &gt;</div>
                        </a>
                    </li>
                    <li>
                        ...
                        <div class="f-16 ">庆幸选择第一农庄网</div>
                        <a href="http://www.01nz.com.cn/notice/229.html" target="_blank">
                            <div id="asdf" class="mt_gs_bb f-14 f_l  mt_gs_jsc">查看他的农家故事 &gt;</div>
                        </a>
                    </li>
                    <li>
                        ...
                        <div class="f-16 ">庆幸选择第一农庄网</div>
                        <a href="http://www.01nz.com.cn/notice/179.html" target="_blank">
                            <div id="asdf" class="mt_gs_bb f-14 f_l  mt_gs_jsd">查看他的农家故事 &gt;</div>
                        </a>
                    </li>
                </ul>
            </div>
            ...
            <div class="mt_xqmr">
                <div class="mt_xq_l mtxql1">
                    <div class="mt_xqltext">
                        <ul>
                            <a href="http://www.01nz.com.cn/" target="_blank">
                                <li>我能在你们这买到土鸡蛋吗？</li>
                            </a>
                            <a href="http://www.01nz.com.cn/" target="_blank">
                                <li>怎么找适合年会的农庄？</li>
        ...
        <div class="mt_xq_t w-100 f_l">
            <div class="mt_ks f-30" onclick="destine();">
                <div class="f_l">快速发布</div>
