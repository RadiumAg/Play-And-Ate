...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
	...
	<div class="mtext"> 
		...
		<div class="tr_yz">
			...
			<div class="opyimictitle"><label class="og">庄源</label>聚集各类农家信息<label class="og">省时、省力、省心</label></div>
		...
		<div class="w-100 f_l">
			...
			<div class="tar_mr">
				<ul>
						...
						<a href="#" target="_blank"><div id="asdf" class="mt_gs_bb f-14 f_l  mt_gs_jsa">查看他发布的农家信息 &gt;</div></a>					
					</li>
														<li>
						<img alt="" class="f_l" src="./第一农庄网：农家推荐_files/562dca1267d5b.jpg" width="108px" height="120px">
						...
						<div class="f-22 ">农家乐没有生意</div>
						<div class="f-16 ">庆幸选择庄源</div>
						<a href="#" target="_blank"><div id="asdf" class="mt_gs_bb f-14 f_l  mt_gs_jhh">查看他发布的农家信息 &gt;</div></a>					
					</li>
														<li>
						<img alt="" class="f_l" src="./第一农庄网：农家推荐_files/562dca1267d5b.jpg" width="108px" height="120px">
						...
						<div class="f-22 ">农家乐没有生意</div>
						<div class="f-16 ">庆幸选择庄源</div>
						<a href="#" target="_blank"><div id="asdf" class="mt_gs_bb f-14 f_l  mt_gs_joo">查看他发布的农家信息 &gt;</div></a>					
					</li>
													<li>
						<img alt="" class="f_l" src="./第一农庄网：农家推荐_files/562dca1267d5b.jpg" width="108px" height="120px">
						...
						<div class="f-22 ">农家乐没有生意</div>
						<div class="f-16 ">庆幸选择庄源</div>
						<a href="#" target="_blank"><div id="asdf" class="mt_gs_bb f-14 f_l  mt_gs_jsb">查看他发布的农家信息 &gt;</div></a>					
					</li>
													<li>
						<img alt="" class="f_l" src="./第一农庄网：农家推荐_files/562dca1267d5b.jpg" width="108px" height="120px">
						...
						<div class="f-22 ">农家乐没有生意</div>
						<div class="f-16 ">庆幸选择庄源</div>
						<a href="#" target="_blank"><div id="asdf" class="mt_gs_bb f-14 f_l  mt_gs_jsc">查看他发布的农家信息 &gt;</div></a>					
					</li>
														<li>
						<img alt="" class="f_l" src="./第一农庄网：农家推荐_files/562dca1267d5b.jpg" width="108px" height="120px">
						...
						<div class="f-22 ">农家乐没有生意</div>
						<div class="f-16 ">庆幸选择庄源</div>
						<a href="#" target="_blank"><div id="asdf" class="mt_gs_bb f-14 f_l  mt_gs_jsd">查看他发布的农家信息 &gt;</div></a>					
					</li>
													</ul>
			</div>
		</div>
			...
			<div class="mt_xqmr">
				<div class="mt_xq_l mtxql1">
					<div class="mt_xqltext">
						<ul>
													<a href="../Home/Home.aspx" target="_blank"><li>我能找到合适的垂钓场吗？</li></a>
													<a href="#"><li>怎么找适合年会的农庄？</li></a>
													<a href="#" ><li>集体出行怎么合适？</li></a>
													<a href="#"><li>和农家老板有分歧怎么办？</li></a>
													<a href="#" ><li>什么是农家优选？</li></a>
													<a href="#"><li>怎么发布需求？</li></a>
													<a href="#" ><li>怎么保证我们低价服务好</li></a>
													<a href="#" ><li>定金的收取和定额规则</li></a>
													<a href="#" ><li>订金是否太高？</li></a>
												</ul>
					</div>
				</div>
			</div>
		...
		<div class="mt_xq_t w-100 f_l">	
			<div class="mt_ks f-30" href="../Home/Home.aspx"><div class="f_l">快速选择</div><div class="mt_ks_r f-30">&gt;</div></div></div>
		</div>
</asp:Content>
