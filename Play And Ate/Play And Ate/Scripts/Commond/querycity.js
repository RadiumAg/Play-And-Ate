(function($){
    $.querycity = function(input,options){
        ...
        $('#bn').append("<div id='pop_city_"+input.attr('id')+"' class='pop_city' style='display:none; left:226px;'><p class='pop_head'></p><ul class='list_label'></ul><div class='pop_city_container'></div></div>");
        $('#bn').append("<div id='suggest_city_"+input.attr('id')+"' class='list_city' style='display:none; left:226px;'><div class='list_city_head'></div><div class='list_city_container'></div><div class='page_break'></div></div>");
