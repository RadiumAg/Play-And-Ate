                        ...
                        <asp:Repeater ID="RPtejiaLine" runat="server">
                            <ItemTemplate>
                                <li class="">
                                    ...
                                    <a target="_blank" href="/Show/FarmDetails.aspx?productId=<%# Eval("ProductID") %>" class="pic_link" rel="nofollow">
                                        <img width="78" height="71" alt="" src='/Images/Tailorism/<%# Eval("Image") %>'></a>
                                    <div class="s_h_w2">
                                        <a target="_blank" href="/Show/FarmDetails.aspx?productId=<%# Eval("ProductID") %>"><%# Eval("ProductName") %></a><br>
                                        <span class="ymargin"><span class="cgrey2">
                                            <div class="line_price" style="width: 120px;">特价：<strong><%# Eval("ProductPrice").ToString().Split('.')[0] %></strong>起</div>
                                        </span></span>
                                    </div>
                                    <div class="clr"></div>
                                </li>
                ...
                <div class="col_side_o top10">
                    ...
                    <ul class="show-hide">
                        <asp:Repeater ID="RPremaiLine" runat="server">
                            <ItemTemplate>
                                <li class="">
                                    <div class="ynum"><%# this.RPremaiLine.Items.Count+1 %>.</div>
                                    <a target="_blank" href="/Show/FarmDetails.aspx?productId=<%# Eval("ProductID") %>" class="pic_link" rel="nofollow">
                                        <img width="78" height="71" alt="" src='/Images/Tailorism/<%# Eval("Image") %>'></a><div class="s_h_w2">
                                            <a target="_blank" href="/Show/FarmDetails.aspx?productId=<%# Eval("ProductID") %>"><%# Eval("ProductName") %></a><br>
                                            <span class="ymargin"><span class="cgrey2">
                                                <div class="line_price" style="width: 120px;">特价：<strong><%# Eval("ProductPrice").ToString().Split('.')[0] %></strong>起</div>
                                            </span></span>
                ...
                <div class="topbanner">
                    <div class="bannerimg" id="divimagebanner">
                        <a href="/Show/FarmDetails.aspx?productId=40" target="_blank" style="display: none;">
                            <!-- 大图片000 -->
                            <img src="/Images/Tailorism/1.jpg" title="" width="770" height="317" border="0" />
                        </a>
                        <a href="/Show/FarmDetails.aspx?productId=41" target="_blank" style="display: inline;">
                            <!-- 大图片000 -->
                            <img src="/Images/Tailorism/2.jpg" title="" width="770" height="317" border="0" />
                        </a>
                        <a href="/Show/FarmDetails.aspx?productId=42" target="_blank" style="display: none;">
                            <!-- 大图片000 -->
                            <img src="/Images/Tailorism/3.jpg" title="" width="770" height="317" border="0" />
                        </a>
                        <a href="/Show/FarmDetails.aspx?productId=43" target="_blank" style="display: none;">
                            <!-- 大图片000 -->
                            <img src="/Images/Tailorism/4.jpg" title="" width="770" height="317" border="0" />
                        </a>
                    </div>
                    <!--滚功图片-->
                    <div class="bannertext" id="divbanner">
                        <ul>
                            <li>
                                <a href="/Show/FarmDetails.aspx?productId=40" target="_blank" class="">快乐岛1
                                </a>
                            </li>
                            <li>
                                <a href="/Show/FarmDetails.aspx?productId=41" target="_blank" class="on">快乐岛11
                                </a>
                            </li>
                            <li>
                                <a href="/Show/FarmDetails.aspx?productId=42" target="_blank" class="">快乐岛111
                                </a>
                            </li>
                            <li>
                                <a href="/Show/FarmDetails.aspx?productId=43" target="_blank" class="">快乐岛1111
                                </a>
                            </li>
                        </ul>
                        <div class="clearit">
                            ...
                            <ItemTemplate>
                                <div class="s_info">
                                    <a href="/Show/FarmDetails.aspx?productId=<%# Eval("ProductID") %>" target="_blank">
                                        <img src="/Images/Tailorism/<%# Eval("Image") %>" width="180" height="137" alt='<%# Eval("ProductName") %>' />
                                        <p class="jieshao"></p>
                ...
                <div class="middle2">
                    <div class="middle01">
                        <div class="shty_top gt">
                            <div class="title gt_tit">
                                <div class="img_tb gentuan_img f_l"></div>
                                跟团行
                            </div>
